...
room * gen_init_room(int selection_seed)
{
	...
	cout << initial_ptr->position.xcoord << endl;	// for DEBUGGING
	cout << initial_ptr->position.ycoord << endl;	// for DEBUGGING
...
void gen_room(room * room_ptr, int selection_seed, char direction)
{
	...
	cout << temp_room_ptr->position.xcoord << endl;  // for DEBUGGING
	cout << temp_room_ptr->position.ycoord << endl;  // for DEBUGGING
